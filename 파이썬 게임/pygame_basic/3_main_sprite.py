...
#캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/tmdgu/Desktop/Youtube Python Project/파이썬 게임/pygame_basic/character.png")
character_size = character.get_rect().size #이미지의 크기를 구해옴
character_width = character_size[0] #캐릭터의 가로크기
character_height = character_size[1] #캐릭터의 세로 크기
character_x_pos = screen_width / 2 #화면가로의 절반 크기에 해당하는 위치(가로)
character_y_pos = screen_height - character_height #화명세로크기 가장아래에
